...
{
    public class SRTPluginProviderSH2R : IPluginProvider
    {
        private Process process;
        private GameMemorySH2RScanner gameMemoryScanner;
        ...
        public int Startup(IPluginHostDelegates hostDelegates)
        {
            ...
            process = GetProcess();
            gameMemoryScanner = new GameMemorySH2RScanner(process);
        ...
        private Process GetProcess() => Process.GetProcessesByName("SHProto-Win64-Shipping")?.FirstOrDefault();
    }
}
